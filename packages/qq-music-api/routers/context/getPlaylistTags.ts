...
import extendApi from '../../module/apis/getPlaylistTags'

/**
 * 获取歌单标签列表
 */
export async function getPlaylistTagsController(ctx: KoaContext) {
 ...
 * 根据标签获取歌单列表
 */
export async function getPlaylistsByTagController(ctx: KoaContext) {
 ...
 * 获取热门评论
 */
export async function getHotCommentsController(ctx: KoaContext) {
 ...
 * 获取歌手分类列表
 */
export async function getSingerListByAreaController(ctx: KoaContext) {
